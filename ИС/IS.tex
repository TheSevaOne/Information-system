...
\end{figure}
	...
	\begin{table}[h]
		...
		\begin{tabular}{|l|l|l|l|}
			...
			ContractSum                                                            & numeric(7,2)\\
			&CHECK (VALUE >0)       &       & Контрактные ср-ва на чел      \\ \hline
		\end{tabular}
	\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		Number                                                             & integer \\ &CHECK (VALUE >0)          &              & Телефон клиента      \\ \hline
...
\begin{table}[h]
	...
	ClientId                                                             & integer           & FK(tblClient)  & Телефон клиента            \\ \hline
			PricewoCom                                                             & integer CHECK\\ &(VALUE >0)  $T*$          &   & Стоимость без скидки 
			 \\ \hline
	\end{tabular}
\end{table}
\begin{table}[h]
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		CheckId                                                            & integer            & РК    & Идентификатор чека \\ \hline
			...
			ContractSum                                                            & numeric(7,2)\\
			&CHECK (VALUE >0)       & FK(tblContract)      & Контрактные ср-ва на чел      \\ \hline
