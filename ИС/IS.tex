...
\begin{figure}[h]
	...
	\begin{minipage}[h]{1\linewidth}
		\centering{ 	\includegraphics[width=1\linewidth]{images/tab.jpg}\\}
		\caption{Модель БД}
	\end{minipage}
...
\end{figure}
	...
	\begin{table}[h]
		...
		\begin{tabular}{|l|l|l|l|}
			...
			DateContract                                                       & date               &       & Дата заключения контракта \\ \hline
			PaidSum                                                            & numeric(7,2)       &       & Оплаченная стоимость      \\ \hline
		\end{tabular}
	\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		CompanyName                                                        & integer            &       & Название организации      \\ \hline
		PaidSum                                                            & numeric(7,2)       &       & Оплаченная стоимость      \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		\hline
		\begin{tabular}[c]{@{}l@{}}Название атрибута\\ (поля)\end{tabular} & Домен  & Ключи          & Описание             \\ \hline
		Number                                                             & integer            & PK             & Телефон клиента      \\ \hline
		ClientName                                                         & varchar(40)        &                & Имя клиента          \\ \hline
		ClientLastName                                                     & varchar(35)        &                & Фамилия клиента      \\ \hline
		ClientMiddleName                                                   & varchar(35)        &                & Отчество клиента     \\ \hline
		PaidSum                                                            & numeric(7,2)       & FK(tblCompany) & Оплаченная стоимость \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		Login                                                              & varchar(40)        &       & Логин                        \\ \hline
		Password                                                           & varchar(35)        &       & Пароль                       \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		PriceDate                                                          & date               &       & Дата утверждения         \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		\hline
		\begin{tabular}[c]{@{}l@{}}Название атрибута\\ (поля)\end{tabular} & Домен  & Ключи & Описание             \\ \hline
		Service                                                            & varchar(40)        &       & Название услуги      \\ \hline
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		Price                                                              & numeric(7,2)       &                & Цена услуги              \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		\hline
		\begin{tabular}[c]{@{}l@{}}Название атрибута\\ (поля)\end{tabular} & Домен  & Ключи          & Описание                   \\ \hline
		VisitData                                                          & date               &                & Дата визита                \\ \hline
		HandlingId                                                         & integer            & PK             & Идентификатор обслуживания \\ \hline
		Service                                                            & varchar(40)        & FK(tblService) & Название услуги            \\ \hline
		Number                                                             & integer            & FK(tblClient)  & Телефон клиента            \\ \hline
	\end{tabular}
\end{table}
