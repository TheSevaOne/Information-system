...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		\multicolumn{1}{|l|}{ContratractSum} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}numeric(7,2)\\ CHECK (VALUE \textgreater 0)\end{tabular}} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}Контрактная сумма \\ на человека\end{tabular}} \\ \hline
