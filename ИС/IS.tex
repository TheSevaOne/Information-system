...
\begin{figure}[h]
	...
	\begin{minipage}[h]{1\linewidth}
		\centering{ 	\includegraphics[width=1\linewidth]{images/REL.jpg}\\}
		\caption{Модель БД}
	\end{minipage}
...
\begin{table}[h]
	...
	Number                                                             & \begin{tabular}[c]{@{}l@{}}integer \\ CHECK (VALUE \textgreater 0)\end{tabular}      & РК    & Телефон клиента                  \\ \hline
...
\begin{table}[h]
	...
	VisitData                                                          & \begin{tabular}[c]{@{}l@{}}date DEFAULT\\ CURDATE()\end{tabular}                     &       & Дата  визита                     \\ \hline
		VisitId                                                         & integer            & PK             & Идентификатор обслуживания \\ \hline
		Service                                                            & varchar(40) NOT NULL       & FK(tblService) & Название услуги            \\ \hline
	ClientId                                                             & integer           & FK(tblClient)  & Телефон клиента            \\ \hline
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		CheckId                                                          & integer            & FK(tblCheck) & Идентификатор счета    \\ \hline
...
ContractSum                                                        & \begin{tabular}[c]{@{}l@{}}numeric(7,2) \\ CHECK (VALUE \textgreater 0)\end{tabular} & FK(tblContract) & \begin{tabular}[c]{@{}l@{}}Контрактные \\ средства на человека\end{tabular} \\ \hline
